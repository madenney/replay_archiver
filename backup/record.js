...
const outputDir = '/path/to/replay_archiver/output';
const ssbmIsoPath = '/path/to/melee_iso/melee(static_fd_background).iso';
const dolphinPath = '/path/to/slippi_launcher/playback/Slippi_Playback-x86_64.AppImage';
const quality = 2;
